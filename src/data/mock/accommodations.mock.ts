...
const generateAccommodations = (): Accommodation[] => {
  ...
  // Narathiwat Accommodations (6 properties)
  const narathiwatDest = DESTINATIONS[11]; // Narathiwat
  
  accommodations.push({
    id: `acc-${String(id++).padStart(3, "0")}`,
    slug: "narathiwat-seaside-resort",
    name: "Narathiwat Seaside Resort",
    typeId: resortType.id,
    destinationId: narathiwatDest.id,
    hostId: "host-014",
    description: "รีสอร์ทริมทะเล วิวหาดนราทัศน์สวยงาม บรรยากาศสงบ ใกล้น้ำตกบาโงสะดุดตา",
    highlights: ["ริมทะเล", "วิวสวยงาม", "ใกล้น้ำตก", "บรรยากาศสงบ", "อาหารทะเลสด"],
  ...
  accommodations.push({
    ...
    destinationId: narathiwatDest.id,
    hostId: "host-015",
    description: "โรงแรมราคาประหยัด ใจกลางเมืองนราธิวาส ใกล้ตลาดโต้รุ่ง สะดวกสบาย",
    highlights: ["ราคาประหยัด", "ใจกลางเมือง", "ใกล้ตลาด", "Wi-Fi ฟรี", "ห้องพักสะอาด"],
