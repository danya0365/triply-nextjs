...
const generateAccommodations = (): Accommodation[] => {
  ...
  // Pattani Accommodations (7 properties)
  const pattaniDest = DESTINATIONS[10]; // Pattani
  
  accommodations.push({
    id: `acc-${String(id++).padStart(3, "0")}`,
    slug: "pattani-beach-resort",
    name: "Pattani Beach Resort",
    typeId: resortType.id,
    destinationId: pattaniDest.id,
    hostId: "host-012",
    description: "รีสอร์ทริมชายหาด วิวทะเลสวยงาม ใกล้หาดปานารี บรรยากาศสงบ อาหารทะเลสด",
    highlights: ["ริมชายหาด", "วิวทะเล", "อาหารทะเลสด", "สระว่ายน้ำ", "บรรยากาศสงบ"],
    address: "123 หมู่ 4 ตำบลตะลุบัน อำเภอสายบุรี ปัตตานี 94110",
    coordinates: { lat: 6.7850, lng: 101.3120 },
    distanceFromCenter: 15.0,
    coverImage: "/images/accommodations/pattani-resort/cover.jpg",
    images: [],
    basePricePerNight: 1800,
    currency: "THB",
    cleaningFee: 500,
    ...
    beds: 2,
    bathrooms: 2,
    amenityIds: ["amen-001", "amen-002", "amen-003", "amen-010", "amen-014", "amen-030", "amen-040", "amen-043"],
    status: "active",
    isInstantBook: true,
    isVerified: true,
    isFeatured: true,
  ...
  accommodations.push({
    id: `acc-${String(id++).padStart(3, "0")}`,
    slug: "pattani-city-hotel",
    name: "Pattani City Hotel",
    typeId: hotelType.id,
    destinationId: pattaniDest.id,
    hostId: "host-013",
    description: "โรงแรมใจกลางเมืองปัตตานี ใกล้มัสยิดกลางเมือง ตลาดเก่า สะดวกสบาย",
    highlights: ["ใจกลางเมือง", "ใกล้มัสยิด", "ใกล้ตลาด", "ห้องพักสะอาด", "ราคาสมเหตุสมผล"],
    address: "88/5 ถนนรุดี ตำบลสะบารัง อำเภอเมืองปัตตานี ปัตตานี 94000",
    coordinates: { lat: 6.8720, lng: 101.2550 },
    distanceFromCenter: 1.0,
    coverImage: "/images/accommodations/pattani-hotel/cover.jpg",
    images: [],
  ...
  // Narathiwat Accommodations (8 properties)
  const narathiwatDest = DESTINATIONS[11]; // Narathiwat
  
  accommodations.push({
    id: `acc-${String(id++).padStart(3, "0")}`,
    slug: "narathiwat-seaside-resort",
    name: "Narathiwat Seaside Resort & Spa",
    typeId: resortType.id,
    destinationId: narathiwatDest.id,
    hostId: "host-014",
    description: "รีสอร์ทหรูริมทะเล วิวหาดนราทัศน์สวยงาม บรรยากาศสงบเป็นส่วนตัว ใกล้น้ำตกบาโงสะดุดตา มีสปาและร้านอาหารทะเลสด",
    highlights: [
      "ริมชายหาดนราทัศน์",
      "วิวพระอาทิตย์ตกสวยงาม",
      "ใกล้น้ำตกบาโงสะดุดตา 15 นาที",
      "สปาและนวดแผนไทย",
      "ร้านอาหารทะเลสด",
    ],
    address: "99 หมู่ 3 ตำบลกะลุวอ อำเภอเมืองนราธิวาส นราธิวาส 96000",
    coordinates: { lat: 6.4350, lng: 101.8350 },
    distanceFromCenter: 8.0,
    coverImage: "/images/accommodations/narathiwat-resort/cover.jpg",
    images: [
      "/images/accommodations/narathiwat-resort/beach.jpg",
      "/images/accommodations/narathiwat-resort/room.jpg",
      "/images/accommodations/narathiwat-resort/pool.jpg",
    ],
    ...
    beds: 2,
    bathrooms: 2,
    amenityIds: ["amen-001", "amen-002", "amen-003", "amen-010", "amen-014", "amen-030", "amen-040", "amen-043", "amen-050"],
    status: "active",
    isInstantBook: true,
    isVerified: true,
    isFeatured: true,
  ...
  accommodations.push({
    id: `acc-${String(id++).padStart(3, "0")}`,
    slug: "narathiwat-budget-hotel",
    name: "Narathiwat Budget Hotel",
    typeId: hotelType.id,
    destinationId: narathiwatDest.id,
    hostId: "host-015",
    description: "โรงแรมราคาประหยัด ใจกลางเมืองนราธิวาส ใกล้ตลาดโต้รุ่ง มัสยิดกลางเมือง สะดวกสบาย",
    highlights: [
      "ราคาประหยัด",
      "ใจกลางเมือง",
      "ใกล้ตลาดโต้รุ่ง 5 นาที",
      "ใกล้มัสยิดกลางเมือง",
      "Wi-Fi ฟรี",
    ],
    address: "56/8 ถนนภูเก็ต ตำบลบางนาค อำเภอเมืองนราธิวาส นราธิวาส 96000",
    coordinates: { lat: 6.4280, lng: 101.8220 },
    distanceFromCenter: 1.5,
    coverImage: "/images/accommodations/narathiwat-hotel/cover.jpg",
    images: [],
    basePricePerNight: 650,
    currency: "THB",
    cleaningFee: 200,
    serviceFeePercentage: 8,
    maxGuests: 2,
  ...
  accommodations.push({
    id: `acc-${String(id++).padStart(3, "0")}`,
    slug: "narathiwat-waterfall-homestay",
    name: "Bango Waterfall Homestay",
    typeId: "type-006", // Homestay
    destinationId: narathiwatDest.id,
    hostId: "host-016",
    description: "โฮมสเตย์ใกล้น้ำตกบาโงสะดุดตา บรรยากาศธรรมชาติ เจ้าของบ้านใจดี อาหารพื้นเมืองรสชาติดี",
    highlights: [
      "ใกล้น้ำตกบาโงสะดุดตา",
      "บรรยากาศธรรมชาติ",
      "อาหารพื้นเมืองรสเด็ด",
      "เจ้าของบ้านเป็นกันเอง",
      "ราคาประหยัด",
    ],
    address: "45 หมู่ 7 ตำบลบาโงสะโต อำเภอบาเจาะ นราธิวาส 96170",
    coordinates: { lat: 6.4580, lng: 101.9120 },
    distanceFromCenter: 25.0,
    coverImage: "/images/accommodations/narathiwat-homestay/cover.jpg",
    images: [],
    ...
    minimumNights: 1,
    cancellationPolicy: "ยกเลิกฟรีภายใน 24 ชั่วโมงก่อนเช็คอิน",
    houseRules: ["ห้ามสูบบุหรี่", "เคารพวัฒนธรรมท้องถิ่น"],
  });
