...
export const DESTINATIONS: Destination[] = [
...

  {
    ...
    country: "ประเทศไทย",
    region: "Southeast Asia",
    description: "เมืองชายแดนใต้สุดของไทย จุดสุดท้ายของแผ่นดินไทย ที่มีเอกลักษณ์ทางวัฒนธรรมอิสลาม-มลายูที่เข้มข้นที่สุดในประเทศไทย ประชากรกว่า 80% นับถือศาสนาอิสลาม มีมัสยิดกว่า 400 แห่งทั่วจังหวัด โดดเด่นด้วยสถาปัตยกรรมมัสยิดที่งดงาม วิถีชีวิตมุสลิมที่แท้จริง อาหารฮาลาลรสเลิศ ขนมหวานมลายูที่มีชื่อเสียง ตลาดโต้รุ่งที่มีบรรยากาศแบบมลายู ประเพณีตากใบ (ตากบาตรเทโว) ที่มีชื่อเสียงระดับโลก ควบคู่ไปกับธรรมชาติที่สวยงาม อาทิ น้ำตกบาโงสะดุดตาที่สวยที่สุดในภาคใต้ ชายหาดที่เงียบสงบ และป่าชายเลนที่อุดมสมบูรณ์ เหมาะสำหรับผู้ที่ต้องการสัมผัสวัฒนธรรมอิสลาม-มลายูที่แท้จริงและธรรมชาติที่บริสุทธิ์",
    highlights: [
      "มัสยิดกลางนราธิวาส - มัสยิดที่ใหญ่และสวยที่สุดในภาคใต้ สถาปัตยกรรมอิสลามแบบมลายูที่งดงาม",
      "มัสยิดวาดีอัลฮุสซัยน์ - มัสยิดเก่าแก่ริมแม่น้ำบางนรา บรรยากาศสงบเงียบ",
      "ตลาดโต้รุ่งนราธิวาส - ตลาดเช้าแบบมลายู อาหารฮาลาล ขนมหวานมลายู โรตี มาตาบะ",
      "ตากใบ (ตากบาตรเทโว) - ประเพณีพุทธศาสนิกชนที่มีชื่อเสียงระดับโลก ความสามัคคีของคนไทยทุกศาสนา",
      "ร้านขนมหวานมลายู - บูลูปูลุต กาละแม บือราซา กาแย ขนมชั้น ขนมหม้อแกง",
      "ร้านอาหารฮาลาล - นาซิดาฆัง กะหรี่ปู ต้มยำกุ้ง แกงมัสมั่น อาหารทะเลสด",
      "น้ำตกบาโงสะดุดตา - น้ำตกที่สวยที่สุดในภาคใต้ 7 ชั้น น้ำใสสะอาด",
      "หาดนราทัศน์ - ชายหาดสวยงามเงียบสงบ ชมพระอาทิตย์ตกที่สวยงาม",
      "หาดปันตายมาส - ชายหาดที่มีบรรยากาศสงบ เหมาะพักผ่อน",
      "วัดโคกพระเจดีย์ - วัดเก่าแก่ที่มีประวัติศาสตร์ สะท้อนความสามัคคีทางศาสนา",
      "อุทยานแห่งชาติบูโด-สุไหงปาดี - ป่าชายเลนที่อุดมสมบูรณ์ นกน้ำหลากหลายชนิด",
      "ตลาดตากใบ - ตลาดริมแม่น้ำบางนรา บรรยากาศแบบมลายู สินค้าหลากหลาย",
      "พิพิธภัณฑ์นราธิวาส - เรียนรู้ประวัติศาสตร์ วัฒนธรรมอิสลาม-มลายู และวิถีชีวิตท้องถิ่น",
      "ศูนย์การเรียนรู้อิสลามศึกษา - เรียนรู้หลักคำสอนอิสลาม วัฒนธรรมมลายู",
      "ร้านผ้าบาติก - ผ้าบาติกลายมลายู สีสันสวยงาม งานฝีมือท้องถิ่น",
    ],
    coverImage: "/images/destinations/narathiwat/cover.jpg",
    images: [
      "/images/destinations/narathiwat/mosque.jpg",
      ...
      "/images/destinations/narathiwat/market.jpg",
      "/images/destinations/narathiwat/sunset.jpg",
      "/images/destinations/narathiwat/food.jpg",
      "/images/destinations/narathiwat/batik.jpg",
    ],
    coordinates: { lat: 6.4254, lng: 101.8253 },
    popularityScore: 65,
    seasonality: {
      best: ["December", "January", "February", "March", "October"],
    ...
    climate: "tropical",
    timezone: "Asia/Bangkok",
    language: ["Thai", "Malay", "Yawi", "Arabic"],
    bestFor: [
      "islamic-culture",
      "muslim-friendly",
      "halal-food",
